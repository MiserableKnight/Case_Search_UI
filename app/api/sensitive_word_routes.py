...
def get_sensitive_words():
    ...
    try:
        ...
        return (
            jsonify({"status": "error", "message": f"获取敏感词列表失败: {str(e)}"}),
            500,
        )
...
def add_sensitive_word():
    ...
    try:
        ...
        return jsonify({"status": "error", "message": f"添加敏感词失败: {str(e)}"}), 500
...
def remove_sensitive_word():
    ...
    try:
        ...
        return jsonify({"status": "error", "message": f"删除敏感词失败: {str(e)}"}), 500
